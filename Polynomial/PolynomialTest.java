...
/**
 * A test class of Polynomial
 * This tests all methods in Polynomial
 * 
 * @author Duong Chau
 * @version HW5
 */ 
public class PolynomialTest extends TestCase{
  ...
  /**
   * this test the constructor
   * test input with zeros coefficient, exponent < 0
   * different orders of the string input, and empty string
   */ 
  ...
  public void testAddTerm(){
    ...
    expected.addTerm(5,5);
    assertTrue(expected.equals(new Polynomial("5 5")));
    try{
      test.addTerm(1,-1);
      fail("Should've thrown IllegalArgumentException.");
    }catch(IllegalArgumentException e){
   ...
   * case of delete term when list is empty
   * also case of throwing exception
   */ 
  ...
  /**
   * this test the getCoefficient method
   * case of get coefficient of term in front - middle - back
   * case of get coefficientof  term when list is empty
   * also case of throwing exception
   */ 
  ...
  /**
   * this test the evaluate method
   * tests result with various value of x
   */ 
  ...
  public void testProduct(){
    ...
    assertTrue(Polynomial.product(a,b).equals(new Polynomial("2.0 3 5 1")));
    a = new Polynomial("1 2");
    assertTrue(Polynomial.product(a,b).equals(new Polynomial("2.0 4 5 2")));
  }
  /**
   * this test toString method
   */ 
  ...
  /**
   * this test the description method
   */ 
